...
class Football_Pool_Admin_Options extends Football_Pool_Admin {
	...
	public static function admin() {
		...
		if ( $action === 'update' ) {
			...
			$joker_switch = ( (int) Football_Pool_Utils::get_fp_option( 'jokers_enabled', 0, 'int' ) !== 1 );
		}
			...
			array(
				...
				'show_save_messages' =>
					array(
						...
						'type'       => 'checkbox',
						'value_type' => 'integer',
						'desc'       => __( 'Also show a messsage on success on the prediction form when using asynchronous saves.', 'football-pool' )
					),
				'erase_personal_data' =>
					array(
